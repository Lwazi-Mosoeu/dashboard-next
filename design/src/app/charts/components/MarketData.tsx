...
const MarketData: React.FC = () => {
  ...
  const scriptAddedRef = useRef(false); // Track whether the script has been added

  useEffect(() => {
    if (!scriptAddedRef.current && containerRef.current) {
      ...
      scriptAddedRef.current = true; // Mark as added
    }
  }, []);
